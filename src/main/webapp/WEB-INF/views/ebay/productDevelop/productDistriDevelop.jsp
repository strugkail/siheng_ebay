...
<div class="container-fluid">
    <form:form class="" id="inputForm" modelAttribute="product" action="${ctx}/product/develop/save">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input class="form-control" id="sellingPrice" name="sellingPrice"  type="text" value="${product.sellingPrice}"placeholder="" >
            </div>
            <label class="col-md-1 control-label text-right" for="freight">运费<span class="help-inline">&nbsp;<font color="red">*</font> </span>：</label>
            <div class="col-md-3">
                <input class="form-control" id="freight" name="freight" type="text"  value="${product.freight}"placeholder="">
            </div>
            <label class="col-md-1 control-label text-right" for="costPrice">成本价<span class="help-inline">&nbsp;<font color="red">*</font> </span>：</label>
            <div class="col-md-3">
                <input type="text" class="form-control" id="costPrice"  name="costPrice" value="${product.costPrice}"  placeholder="">
            </div>
        </div>
        <hr/>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input class="form-control" id="declaredValue" name="declaredValue"  type="text" value="${product.declaredValue}"  placeholder="" >
            </div>
            <label class="col-md-1 control-label text-right" for="defaultWeight">重量<span class="help-inline">&nbsp;<font color="red">*</font> </span>：</label>
            <div class="col-md-3">
                <input class="form-control" id="defaultWeight" name="defaultWeight"  type="text" value="${product.defaultWeight}"  placeholder="">
            </div>
            <label class="col-md-1 control-label text-right" for="profitMargin">利润率<span class="help-inline">&nbsp;<font color="red">*</font> </span>：</label>
            <div class="col-md-3">
                <input class="form-control" id="profitMargin" name="profitMargin"  type="text"  value="${product.profitMargin}" >
            </div>
        </div>
        <hr/>
        ...
        <div class="row" style="margin-left: 50px;">
            <button class="btn btn-primary" id="mySave" type="submit"  onclick="save(); return false;">保存</button>
            <button class="btn btn-primary" id="myDevelop" type="submit" onclick="develop(); return false;">开发</button>
        </div>
