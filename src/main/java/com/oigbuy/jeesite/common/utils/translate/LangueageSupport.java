...
public class LangueageSupport {
    ...
    public static final String Azeerbaijani = "az";
    ...
    public static final String Cebuano = "cebOrISO-639-2";
    public static final String ChineseOrSimplified = "zh-CNOrBCP-47";
    public static final String ChineseOrTraditional = "zh-TWOrBCP-47";
    ...
    public static final String HaitianOrCreole = "ht";
    public static final String Hausa = "ha";
    public static final String Hawaiian = "hawOrISO-639-2";
    public static final String Hebrew = "iw";
    public static final String Hindi = "hi";
    public static final String Hmong = "hmnOrISO-639-2";
    ...
    public static final String MyanmarOrBurmese = "my";
    public static final String Nepali = "ne";
    public static final String Norwegian = "no";
    public static final String NyanjaOrChichewa = "ny";
    ...
    public static final String ScotsOrGaelic = "gd";
    ...
    public static final String SinhalaOrSinhalese = "si";
    ...
    public static final String TagalogOrFilipino = "tl";
