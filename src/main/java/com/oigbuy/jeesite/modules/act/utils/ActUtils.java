 ...
 */
package com.oigbuy.jeesite.modules.act.utils;
...
import com.oigbuy.jeesite.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_TEST_EABY = new String[]{"ebayprocess", "t_ebay_process_business"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
