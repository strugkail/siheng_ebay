 ...
 */
package com.oigbuy.jeesite.modules.act.web;
...
import com.oigbuy.jeesite.modules.act.service.ActTaskService;
...
public class ActTaskController extends BaseController {
	...
	public String todoList(Act act, HttpServletResponse response, Model model) throws Exception {
		List<Act> list = actTaskService.todoList();
	...
	public String histoicFlow(Act act, String startAct, String endAct, Model model){
		if (StringUtils.isNotBlank(act.getProcInsId())){
			...
			String taskId = generalProcessService.getTaskId(act.getProcInsId());
	...
	public String form(Act act, HttpServletRequest request, Model model){
		...
		if("development".equals(taskDefKey)){
			formKey="/oa/testAudit/form";
		}
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.oigbuy.jeesite.modules.act.utils.PropertyType
	 */
